...
Теперь находясь в папке nginx перемещаем туда файлы [docker-compose.yml](docker-compose.yml) и [nginx.conf](nginx.conf)

# Возможно нужно сначала настроить вторую машину
